...
CREATE TABLE evalua_comite (
    ...
    actividades NUMBER(1) NOT NULL CHECK (actividades IN (2,3,5)),
    experiencia NUMBER(1) NOT NULL CHECK (experiencia IN (1,2,3,4,5)),
    recomendacion NUMBER(1) NOT NULL CHECK (recomendacion IN (2,3,5)),
    objetivo NUMBER(1) NOT NULL CHECK (objetivo IN (1,3,4,5)),
    intereses NUMBER(1) NOT NULL CHECK (intereses IN (1,3,4,5)),
    retribucion NUMBER(1) NOT NULL CHECK (retribucion IN (1,3,4,5)),
...
INSERT INTO documento_presentado (id_postulacion, id_documento, url_archivo, fecha_entrega) VALUES (4, 2, 'https://archivo.com/doc_19.pdf', TO_DATE('2024-04-27', 'YYYY-MM-DD'));
INSERT INTO documento_presentado (id_postulacion, id_documento, url_archivo, fecha_entrega) VALUES (4, 1, 'https://archivo.com/doc_20.pdf', TO_DATE('2024-04-20', 'YYYY-MM-DD'));
...
COMMIT;
--Tabla 19
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (1, 5, 1, 6564, 'Evaluación automática 1');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (2, 6, 2, 9934, 'Evaluación automática 2');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (3, 3, 3, 8303, 'Evaluación expertos G2');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (4, 6, 4, 2338, 'Evaluación automática 4');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (5, 4, 5, 3403, 'Evaluación  expertos G2');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (6, 6, 6, 7324, 'Evaluación automática 6');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (7, 2, 7, 5931, 'Evaluación automática 7');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (8, 1, 8, 1336, 'Evaluación  expertos G2');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (9, 6, 9, 3817, 'Evaluación automática 9');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (10, 3, 10, 4314, 'Evaluación automática 10');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (11, 5, 11, 3971, 'Evaluación automática 11');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (12, 1, 12, 7038, 'Evaluación  expertos G2');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (13, 3, 13, 9053, 'Evaluación automática 13');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (14, 3, 14, 1170, 'Evaluación automática 14');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (15, 2, 15, 3114, 'Evaluación expertos G2');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (16, 5, 16, 4711, 'Evaluación automática 16');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (17, 2, 17, 1126, 'Evaluación automática 17');
INSERT INTO evalua_comite (id_documento_presentado, id_subcriterio, id_ponderacion, id_evaluador, comentario) VALUES (18, 4, 18, 6952, 'Evaluación  expertos G2');
